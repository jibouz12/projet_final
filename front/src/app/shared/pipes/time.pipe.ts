...
/////////////////////////
/// calculer les valeurs en ml
/// faire la différence entre Maintenant et la date du post
/// afficher un texte en fonction du résultat
export class TimePipe implements PipeTransform {
    timeDiffs = {
      ...
      transform (value: string | Date ) : any {
            ...
            const diff = dateNow - originalDate;
